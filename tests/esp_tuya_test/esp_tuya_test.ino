#include "Arduino.h"
#include "C:/Users/AVG/Documents/Electrical Main (Amir)/Arduino/Projects/Serge/Blinds V4/tests/esp_tuya_test/include.h"  // << Only works if the .ino is names the same as the parent folder
